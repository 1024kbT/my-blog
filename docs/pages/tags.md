...
- [Karpathy Coding Guidelines：编码约束与执行准则](/posts/engineering/karpathy-coding-guidelines)
...
- [CLI 入口层设计](/posts/ai-core/cli-entry-layer-design)
- [应用编排层 (App) 设计](/posts/ai-core/application-orchestration-layer-design)
- [Agent 多轮对话引擎设计](/posts/ai-core/agent-multi-turn-dialog-engine-design)
- [提示词模板系统设计](/posts/ai-core/prompt-template-system-design)
- [记忆机制的数据结构与信息提取](/posts/ai-core/memory-structure-and-information-extraction)
...
- [本地数据持久化设计](/posts/ai-infra/local-data-persistence-design)
...
- [为什么我想要一个“能长期写下去”的博客](/posts/essay/why-a-real-blog-matters)
