...
> 💡 完整的 MCP 服务器列表请参考附录 [MCP 服务器大全](/easy-vibe/zh-cn/appendix/8-artificial-intelligence/ai-protocols)
...
- [使用 Azure 容器应用生成 TypeScript MCP 服务器](https://learn.microsoft.com/easy-vibe/zh-cn/azure/developer/ai/build-mcp-server-ts)
...
- [MCP 生产环境 15 条最佳实践](https://learn.microsoft.com/easy-vibe/zh-cn/azure/azure-functions/scenario-mcp-apps)
