...
::: tip PRD 入口
本项目的需求文档在 GitHub： [查看 PRD](https://github.com/datawhalechina/easy-vibe/blob/main/docs/easy-vibe/zh-cn/stage-2/assignments/simple-grocery-microservices/PRD.md)
:::
