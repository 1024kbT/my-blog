...
你需要参考该教程，对如何使用 Github 进行研究，将自己的项目上传至 Github：[什么是 Github](/easy-vibe/zh-cn/stage-2/backend/git-workflow/)

此外，你还需要学会如何使用 Zeabur，将其连接到 Github，并成功部署你的项目：[什么是 Zeabur](/easy-vibe/zh-cn/stage-2/backend/zeabur-deployment/)
...
你也可以参考 Yerim 写的 [使用设计和代码 Agent 制作网页](/easy-vibe/zh-cn/stage-1/appendix-articles/example0-2/vibe-coding-tools-build-website-with-ai-coding-and-design-agents) 教程，进行个人作品集或任意功能简单网页的快速搭建。
