...
如果你想深入学习 API 开发，请参考 [API 章节](../4-server-and-backend/api-intro.md)。
:::
...
::: info 💡 进阶学习
如果你想深入了解某个环节，可以参考：
- **API 开发**：[API 简介](../4-server-and-backend/api-intro.md) - 学习如何设计和使用 API
- **前端性能**：[前端性能优化](../3-browser-and-frontend/web-performance.md) - 学习如何优化网页加载速度
- **浏览器渲染**：[浏览器渲染管道](../3-browser-and-frontend/browser-as-os-rendering.md) - 深入了解渲染细节
:::
