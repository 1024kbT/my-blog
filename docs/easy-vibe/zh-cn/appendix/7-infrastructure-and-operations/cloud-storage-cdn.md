...
- **HTTP 请求流程**：可以先阅读 [浏览器输入 URL 后发生了什么](../4-server-and-backend/request-journey.md) 了解完整的请求链路。
- **DNS 解析原理**：如果你对域名解析还不太熟悉，可以先看 [DNS 查询流程](../4-server-and-backend/request-journey.md) 的图解部分。
