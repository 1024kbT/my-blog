...
::: info 预习提示
如果你还不熟悉 IDE 是什么、各个界面元素有什么作用，建议先阅读 [IDE 简介](/easy-vibe/zh-cn/appendix/2-development-tools/ide-basics) 进行预习，了解 IDE 的基本概念和常见功能。
:::
...
更具体的详细内容解释，请查看[附录中的 虚拟 IDE 可视化 IDE 原理部分](/easy-vibe/zh-cn/appendix/2-development-tools/ide-basics)。
