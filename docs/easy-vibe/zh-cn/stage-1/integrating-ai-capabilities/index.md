...
::: info ℹ️ 什么是 API
对于 API 的更深入的解释，请看附录：[API 入门](/easy-vibe/zh-cn/appendix/4-server-and-backend/api-intro)。
...
::: info ℹ️ 原理延伸
如果你想了解更多原理相关的内容，请查看附录：[大语言模型（LLM）入门](/easy-vibe/zh-cn/appendix/8-artificial-intelligence/llm-principles)。
...
::: info ℹ️ 原理延伸
如果你想了解更多原理相关的内容，请查看附录：[视觉语言模型（VLM）入门](/easy-vibe/zh-cn/appendix/8-artificial-intelligence/multimodal-models)。
...
::: info ℹ️ 原理延伸
如果你想了解更多原理相关的内容，请查看附录：[图像生成入门](/easy-vibe/zh-cn/appendix/8-artificial-intelligence/image-generation)。
