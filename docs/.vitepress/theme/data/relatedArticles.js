...
const rawRelatedArticlesMap = {
  'zh-cn/stage-1/learning-map': [
    {
      href: '/easy-vibe/zh-cn/stage-1/ai-capabilities-through-games/',
      title: '0.2 用“小游戏”理解 AI 能力边界',
      description: '先用游戏化方式建立手感，快速理解“什么问题适合交给 AI”。',
      icon: '🎮'
    },
    {
      href: '/easy-vibe/zh-cn/stage-1/finding-great-idea/',
      title: '1.0 找到值得做的点子',
      description: '把“我有想法”变成“我有可验证的产品方向”。',
      icon: '💡'
    },
    {
      href: '/easy-vibe/zh-cn/stage-1/building-prototype/',
  ...
  'zh-cn/stage-1/ai-capabilities-through-games': [
    {
      href: '/easy-vibe/zh-cn/stage-1/introduction-to-ai-ide/',
    ...
    {
      href: '/easy-vibe/zh-cn/stage-1/learning-map/',
      title: '返回学习地图',
  ...
  'zh-cn/stage-1/introduction-to-ai-ide': [
    ...
    {
      href: '/easy-vibe/zh-cn/stage-1/integrating-ai-capabilities/',
  ...
  'zh-cn/stage-1/building-prototype': [
    ...
    {
      href: '/easy-vibe/zh-cn/stage-1/complete-project-practice/',
      title: '初级五：完整项目实战',
