...
description: 从上下文、工具、技能、Hook 与 Subagent 等层面整理 Claude Code 的工程化使用方法。
outline: deep
---
...
# 2. 概念边界：MCP / Plugin / Tools / Skills / Hooks / Subagents 2. 边界概念：MCP / Plugin / Tools / Skills / Hooks / Subagents
...
下面几个例子都来自我在开源 terminal 项目 https://github.com/tw93/Kaku 里的实际 Skill，比较直观。
...
- 一个 Skill 覆盖 review、deploy、debug、docs、incident 五件事
  一个技能覆盖 review、deploy、debug、docs、incident 五件事
...
- 对大响应支持 response_format: concise / detailed
  对大电影手机手机 response_format：简洁/详细
...
[Kaku
死板的](https://github.com/tw93/Kaku)
